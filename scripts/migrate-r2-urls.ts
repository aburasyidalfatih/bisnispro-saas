...
async function main() {
  console.log("Memulai migrasi URL lokal ke R2 Cloudflare...")
  ...
  // 1. FileUpload
  console.log("Migrasi FileUpload...")
  ...
  console.log(`- FileUpload: ${files.length} records updated.`)
  totalUpdates += files.length
