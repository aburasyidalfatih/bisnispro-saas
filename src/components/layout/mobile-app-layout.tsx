...
export function MobileAppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex justify-center w-full font-sans bg-muted/20">
      ...
      <div className="w-full max-w-[480px] bg-background min-h-screen relative shadow-2xl flex flex-col overflow-hidden lg:my-0 ring-1 ring-border/50 max-w-full">
