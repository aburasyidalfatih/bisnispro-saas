...
export const provinces: Province[] = [
  ...
  { id: "14", name: "Riau", lat: 1.7377, lng: 102.1310 },
  { id: "15", name: "Jambi", lat: -1.4852, lng: 102.4381 },
  { id: "16", name: "Sumatera Selatan", lat: -3.3194, lng: 104.9147 },
  ...
  { id: "21", name: "Kepulauan Riau", lat: 3.9457, lng: 108.1429 },
  { id: "31", name: "DKI Jakarta", lat: -6.2088, lng: 106.8456 },
  { id: "32", name: "Jawa Barat", lat: -6.9175, lng: 107.6191 },
  { id: "33", name: "Jawa Tengah", lat: -7.1510, lng: 110.1403 },
  ...
  { id: "73", name: "Sulawesi Selatan", lat: -3.6688, lng: 119.9741 },
  { id: "74", name: "Sulawesi Tenggara", lat: -4.1449, lng: 122.1748 },
  { id: "75", name: "Gorontalo", lat: 0.6999, lng: 122.4467 },
  { id: "76", name: "Sulawesi Barat", lat: -2.8442, lng: 119.2321 },
  { id: "81", name: "Maluku", lat: -3.2385, lng: 130.1453 },
  { id: "82", name: "Maluku Utara", lat: 1.5710, lng: 127.8088 },
  { id: "91", name: "Papua", lat: -2.5337, lng: 140.7181 },
  { id: "92", name: "Papua Barat", lat: -1.3361, lng: 133.1747 },
  { id: "93", name: "Papua Selatan", lat: -6.3600, lng: 139.3800 },
  { id: "94", name: "Papua Tengah", lat: -3.5900, lng: 136.2300 },
  { id: "95", name: "Papua Pegunungan", lat: -4.0800, lng: 138.5200 },
  { id: "96", name: "Papua Barat Daya", lat: -2.0500, lng: 132.2400 },
]

export function findProvinceByName(name: string): Province | undefined {
  if (!name) return undefined
  const normalized = name.trim().toLowerCase()
  return provinces.find(p => p.name.toLowerCase() === normalized)
}
