    ...
    Credentials({
      ...
      async authorize(credentials) {
        ...
        if (!user || !user.isActive) {
          ...
          logger.error("Gagal login: Email atau password salah / tidak aktif", undefined, { method: "LOGIN", email })
        ...
        if (!isValid) {
          ...
          logger.error("Gagal login: Password salah", undefined, { method: "LOGIN", userId: user.id, email })
          throw new CustomAuthError("Email atau password salah")
        }
