      ...
      <Dialog open={isSettingsOpen} onOpenChange={setIsSettingsOpen}>
        <DialogContent className="rounded-3xl max-w-md">
          ...
          <DialogFooter>
            ...
            <button onClick={handleSaveSettings} disabled={savingSettings} className="justify-center items-center flex rounded-xl gap-2 border-0 btn-gradient text-white">
