    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Kirim pengumuman massal ke Tenant atau Mitra Afiliasi.</p>
        </div>
      </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <Select value={form.target} onValueChange={(val) => setForm({ ...form, target: val })}>
                    ...
                    <SelectContent>
                      <SelectItem value="all_tenants">Semua Tenant (Sekolah Aktif)</SelectItem>
                      <SelectItem value="pending_tenants">Tenant Menunggu Review (PENDING)</SelectItem>
                      <SelectItem value="free_tenants">Tenant Versi Gratis (Free Plan)</SelectItem>
                      <SelectItem value="pro_tenants">Tenant Versi Premium (Pro Plan)</SelectItem>
