  ...
  return (
    <div className="space-y-8 mt-6">
      ...
      <div>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <Card className="glass border-0">
            <CardHeader>
              ...
              <CardDescription>Dari mana pengunjung website bisnis berasal.</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <div className="space-y-2">
                  {data.visitorStats.sources.slice(0, 10).map((src, i) => {
                    ...
                    const icons: Record<string, string> = {
                      ...
                      telegram: '✈️', direct: '🔗', bisnispro: '🏫', bing: '🔎',
                    }
                    return (
        ...
        {/* Top Bisnis by Traffic */}
        {data.visitorStats.topTrafficTenants.length > 0 && (
          <Card className="glass border-0 mt-6">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 text-base">
                <TrendingUp className="h-5 w-5 text-cyan-500" /> Top 10 Website Bisnis Terbanyak Dikunjungi
              </CardTitle>
              ...
              <div className="h-[220px] w-full">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={[
                    ...
                    <YAxis stroke="#6b7280" fontSize={12} tickLine={false} axisLine={false} allowDecimals={false} />
                    <RechartsTooltip contentStyle={{ borderRadius: '12px', border: 'none', boxShadow: '0 4px 6px -1px rgb(0 0 0 / 0.1)' }} />
                    <Bar dataKey="value" name="Bisnis" radius={[6, 6, 0, 0]} barSize={36}>
      ...
      <div>
        <h2 className="text-lg font-bold mb-3 flex items-center gap-2"><Star className="h-5 w-5 text-yellow-500" /> Skor Engagement Bisnis</h2>
        <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
          <Card className="glass border-0">
                ...
                {data.engagementStats.avgScorePerPlan.map(ps => (
                  <div key={ps.plan}>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-sm font-bold">{ps.avgScore}/100 <span className="text-[10px] text-muted-foreground font-normal">({ps.count} bisnis)</span></span>
                    </div>
          ...
          <Card className="glass border-0">
            <CardHeader><CardTitle className="text-base">Distribusi Skor</CardTitle><CardDescription>Sebaran skor engagement seluruh bisnis.</CardDescription></CardHeader>
            <CardContent>
      ...
      <div>
        ...
        <Card className="glass border-0">
          <CardHeader><CardTitle className="text-base">Fitur yang Digunakan Bisnis</CardTitle><CardDescription>Berapa banyak bisnis yang mengaktifkan setiap fitur. Data ini menentukan selling point.</CardDescription></CardHeader>
          <CardContent>
                ...
                return (
                  <div key={f.feature} className="flex items-center gap-3 p-3 rounded-xl border bg-card hover:shadow-md transition-shadow">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[9px] text-muted-foreground mt-0.5">{pct.toFixed(1)}% dari {data.totalTenants} bisnis</p>
                    </div>
                  </div>
                )
              })}
