  ...
  return (
    <div className="bg-background min-h-screen pb-12">
      ...
      <PageHeader
        ...
        breadcrumbs={buildDynamicBreadcrumbs(tenant.websiteMenus || [], "/download", "Unduhan")}
      />
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        {documents.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-32 bg-white/50 rounded-[3rem] border border-dashed border-border/60">
             ...
             <p className="text-muted-foreground max-w-sm text-center">Dokumen, formulir, atau materi digital akan segera diunggah oleh perusahaan.</p>
          </div>
        ) : (
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-16">
         <div className="bg-primary/5 rounded-3xl p-8 border border-primary/10 flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
               ...
               <p className="text-sm text-muted-foreground">Silakan hubungi bagian tata usaha perusahaan untuk bantuan informasi lebih lanjut.</p>
            </div>
