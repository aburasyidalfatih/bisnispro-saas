...
export function PrestasiList({ achievements, base }: { achievements: any[], base: string }) {
  ...
  const getTypeBadge = (type: string) => {
    switch (type) {
      case "SISWA":
        return { label: "Siswa", color: "bg-blue-500 text-white" }
      case "GURU":
        return { label: "Guru & Staf", color: "bg-emerald-500 text-white" }
      case "SEKOLAH":
