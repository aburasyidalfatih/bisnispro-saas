...
export function FacilitiesSection({ facilities, base }: FacilitiesSectionProps) {
            ...
            return (
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 to-transparent p-4 pt-12">
                  <h3 className="text-white font-bold text-sm md:text-base drop-shadow-lg line-clamp-1">
                    {facility.name}
                  </h3>
                  {facility.description && (
                    <p className="text-white/70 text-xs mt-1 line-clamp-1 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                      {facility.description}
                    </p>
                  )}
                </div>
