...
export function FloatingWhatsApp({ whatsappNumber, message = "Halo, saya ingin bertanya tentang pendaftaran." }: FloatingWhatsAppProps) {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 left-6 z-50 flex items-center justify-center p-3 rounded-full bg-[#25D366] text-white shadow-2xl transition-all duration-500 ease-out hover:scale-110 hover:shadow-[0_0_20px_rgba(37,211,102,0.5)] active:scale-95 group ${
