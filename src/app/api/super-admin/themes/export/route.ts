...
// =============================================
const TEMPLATE_PENGUMUMAN_HBS = `<section class="py-20">
  <div class="max-w-7xl mx-auto px-8">
...
// =============================================
const TEMPLATE_PENGUMUMAN_DETAIL_HBS = `<article class="py-16">
  <div class="max-w-3xl mx-auto px-8">
...
// TEMPLATE: PPDB
// =============================================
const TEMPLATE_PPDB_HBS = `<!-- Hero PPDB -->
...
// TEMPLATE: ALUMNI
// =============================================
const TEMPLATE_ALUMNI_HBS = `<section class="py-20">
  <div class="max-w-7xl mx-auto px-8">
...
// =============================================
const TEMPLATE_AGENDA_HBS = `<section class="py-20">
  <div class="max-w-7xl mx-auto px-8">
...
// =============================================
const TEMPLATE_UNDUHAN_HBS = `<section class="py-20">
  <div class="max-w-4xl mx-auto px-8">
...
// =============================================
const TEMPLATE_GURU_DETAIL_HBS = `<section class="py-20">
  <div class="max-w-4xl mx-auto px-8">
