...
import { Shield, Target, TrendingUp, Handshake, ChevronRight, CheckCircle2 } from "lucide-react"
          ...
          <div className="relative">
            ...
            <div className="relative glass rounded-[2rem] p-8 md:p-10 border shadow-2xl">
              <div className="text-center mb-8">
                <h2 className="text-2xl font-bold">Masuk / Daftar Afiliasi</h2>
                <p className="text-sm text-muted-foreground mt-2">Gunakan akun Google Anda untuk mengakses dashboard kemitraan.</p>
              </div>
              ...
              <div className="space-y-6 pt-4">
                    ...
                    <p className="text-xs text-center text-muted-foreground mt-4">
                      Dengan melanjutkan, Anda menyetujui Syarat & Ketentuan program Afiliasi SchoolPro.
                    </p>
                  </div>
            </div>
          </div>
