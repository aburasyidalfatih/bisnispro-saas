      ...
      <div className="print-container">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 print:grid-cols-2 print:gap-4">
          {staff.map((person) => {
            ...
            return (
              <div key={person.id} className="id-card-wrapper bg-white border shadow-md print:shadow-none rounded-[20px] overflow-hidden w-[320px] h-[480px] mx-auto flex flex-col relative print:border-2 print:border-slate-300 print:break-inside-avoid max-w-full">
