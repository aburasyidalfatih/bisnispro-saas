...
import { ArrowLeft, Save, ImageIcon, Trophy, Sparkles, Wand2, Loader2 as Loader2Icon } from"lucide-react"
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button asChild variant="ghost" size="icon" className="h-8 w-8 rounded-full">
            <Link href="/admin/website/extracurriculars">
        ...
        <div className="lg:col-span-1 space-y-6">
          <Card className="glass border-0 overflow-hidden shadow-sm">
            ...
            <CardContent className="space-y-6 pt-6">
              <button type="submit" className="justify-center items-center flex w-full gap-2 btn-gradient text-white border-0 rounded-xl" disabled={saving || !formData.name}>
                {saving ? (
                  <>
        ...
        <DialogContent className="sm:max-w-[500px] rounded-2xl">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              Generate Promosi Ekskul
            </DialogTitle>
            <DialogDescription>
              AI akan membuat kalimat promosi yang menarik agar siswa baru mau bergabung dengan ekskul ini.
            </DialogDescription>
          </DialogHeader>
          
          <div className="space-y-4 py-4">
            <div className="space-y-2">
              <Label>Tujuan / Kegiatan Utama <span className="text-red-500">*</span></Label>
              <Textarea 
                value={aiInputText}
                onChange={(e) => setAiInputText(e.target.value)}
                placeholder="Contoh: Belajar baris berbaris, melatih disiplin, sering ikut lomba tingkat kota, dapat sertifikat."
