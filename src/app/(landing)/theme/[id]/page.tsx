...
const DUMMY_TENANT = {
  ...
  about: "SMA Prestasi Bangsa adalah sekolah unggulan yang berdedikasi untuk memberikan pendidikan berkualitas tinggi berbasis karakter dan teknologi. Berdiri sejak tahun 1985, kami telah menghasilkan ribuan alumni yang berkontribusi di berbagai bidang. Kami mempersiapkan siswa untuk siap menghadapi tantangan global dengan fasilitas lengkap dan tenaga pengajar profesional.",
  ...
  settings: {
    ...
    visi: "Menjadi sekolah unggulan yang menghasilkan lulusan beriman, bertaqwa, berilmu, dan berkarakter mulia serta berdaya saing global.",
    misi: "<ol><li>Menyelenggarakan pendidikan yang bermutu dan berdaya saing</li><li>Mengembangkan potensi akademik dan non-akademik siswa</li><li>Menanamkan nilai-nilai karakter, keimanan, dan ketaqwaan</li><li>Membangun kerjasama dengan masyarakat dan dunia usaha</li><li>Memanfaatkan teknologi informasi dalam pembelajaran</li></ol>",
    npsn: "20100123",
    akreditasi: "A (Unggul)",
  ...
  facilities: [
    ...
    { id: "f2", name: "Perpustakaan Digital", description: "Menyediakan ribuan buku fisik dan e-book. Ruang baca nyaman ber-AC dengan kapasitas 150 siswa.", imageUrl: "https://images.unsplash.com/photo-1507842217343-583bb7270b66?q=80&w=400&auto=format&fit=crop", category: "Akademik" },
    { id: "f3", name: "Lapangan Olahraga", description: "Fasilitas olahraga standar nasional: lapangan futsal, basket, voli, dan lintasan lari.", imageUrl: "https://images.unsplash.com/photo-1526232761682-d26e03ac148e?q=80&w=400&auto=format&fit=crop", category: "Olahraga" },
    ...
    { id: "f5", name: "Masjid Sekolah", description: "Masjid berkapasitas 500 jamaah dengan fasilitas wudhu yang memadai.", imageUrl: "https://images.unsplash.com/photo-1585036156261-1e2ac5b81414?q=80&w=400&auto=format&fit=crop", category: "Ibadah" },
  ...
  staff: [
    { id: "s1", name: "Dr. H. Ahmad Fauzi, M.Pd", role: "Kepala Sekolah", imageUrl: "https://ui-avatars.com/api/?name=AF&background=4f46e5&color=fff", nip: "196507151990021001", email: "ahmad.fauzi@prestasibangsa.sch.id", sortOrder: 1 },
    { id: "s2", name: "Dra. Siti Aminah, M.Si", role: "Wakil Kepala Sekolah Kurikulum", imageUrl: "https://ui-avatars.com/api/?name=SA&background=e11d48&color=fff", nip: "197003201995032001", email: null, sortOrder: 2 },
    { id: "s3", name: "Ir. Budi Santoso, M.Eng", role: "Guru Fisika", imageUrl: "https://ui-avatars.com/api/?name=BS&background=059669&color=fff", nip: "198012101005011002", email: null, sortOrder: 3 },
    { id: "s4", name: "Rina Wulandari, S.Pd", role: "Guru Bahasa Inggris", imageUrl: "https://ui-avatars.com/api/?name=RW&background=d97706&color=fff", nip: null, email: null, sortOrder: 4 },
    { id: "s5", name: "Agus Setiawan, S.Kom", role: "Guru TIK", imageUrl: "https://ui-avatars.com/api/?name=AS&background=7c3aed&color=fff", nip: null, email: null, sortOrder: 5 },
    { id: "s6", name: "Dewi Lestari, S.Pd", role: "Guru Matematika", imageUrl: "https://ui-avatars.com/api/?name=DL&background=0ea5e9&color=fff", nip: null, email: null, sortOrder: 6 },
  ],
  programs: [
    ...
    { id: "p2", name: "Program Bilingual", description: "Pembelajaran dengan dua bahasa pengantar (Indonesia & Inggris) untuk mempersiapkan siswa bersaing global.", imageUrl: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?q=80&w=400&auto=format&fit=crop" },
  ...
  extracurriculars: [
    { id: "e1", name: "Pramuka", description: "Kegiatan kepanduan untuk membentuk karakter kepemimpinan dan kemandirian siswa.", imageUrl: "https://images.unsplash.com/photo-1524178232363-1fb2b075b655?q=80&w=400&auto=format&fit=crop" },
    { id: "e2", name: "Robotika", description: "Klub robotik dengan fasilitas lengkap. Rutin mengikuti kompetisi nasional dan internasional.", imageUrl: "https://images.unsplash.com/photo-1561557944-6e7860d1a7eb?q=80&w=400&auto=format&fit=crop" },
    { id: "e3", name: "Paduan Suara", description: "Mengasah bakat seni musik vokal dan tampil di berbagai acara sekolah serta lomba.", imageUrl: "https://images.unsplash.com/photo-1507838153414-b4b713384a76?q=80&w=400&auto=format&fit=crop" },
  ],
  achievements: [
  ...
  alumni: [
    ...
    { id: "al2", name: "Arief Rahman, M.Sc", graduationYear: 2010, currentPosition: "Data Scientist — Google Singapore", imageUrl: "https://ui-avatars.com/api/?name=AR&background=059669&color=fff", testimonial: "Guru-guru di sini benar-benar menginspirasi. Berkat mereka saya menekuni bidang sains dan teknologi hingga akhirnya berkarir di perusahaan teknologi global." },
...
export default async function ThemeDemoPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    const themeContext = {
      ...
      stats: [
        { value: "1250+", label: "Siswa Aktif", icon: "users" },
