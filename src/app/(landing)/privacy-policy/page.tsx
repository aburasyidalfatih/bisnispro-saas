    ...
    <div className="bg-background min-h-screen pt-24 pb-16">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="prose prose-slate max-w-none text-muted-foreground prose-headings:text-foreground prose-a:text-primary">
          <p>
            Selamat datang di SchoolPro. Kami sangat menghargai privasi Anda dan berkomitmen untuk melindungi informasi pribadi dan data sekolah Anda. Kebijakan privasi ini menjelaskan bagaimana kami mengumpulkan, menggunakan, dan melindungi data Anda saat menggunakan platform SaaS SchoolPro.
          </p>

          <h2>1. Informasi yang Kami Kumpulkan</h2>
          <p>
            Kami mengumpulkan informasi dari Anda secara langsung ketika Anda mendaftarkan lembaga Anda, berlangganan layanan kami, menggunakan fitur platform, atau menghubungi tim dukungan kami. Informasi tersebut mencakup:
          </p>
          <ul>
            <li><strong>Informasi Akun & Lembaga:</strong> Nama lengkap, alamat email, nomor telepon, nama sekolah, NPSN, dan dokumen legalitas sekolah.</li>
            <li><strong>Informasi Pengguna Akhir (Siswa, Guru, Orang Tua):</strong> Data akademik, presensi, keuangan (SPP), dan data kontak yang dimasukkan oleh pihak sekolah.</li>
            <li><strong>Informasi Sistem & Penggunaan:</strong> Alamat IP, jenis browser, data log aktivitas, dan cookie.</li>
          </ul>

          <h2>2. Penggunaan Informasi</h2>
          <p>
            SchoolPro memproses data Anda untuk:
          </p>
          <ul>
            <li>Menyediakan, mengoperasikan, dan meningkatkan layanan platform manajemen sekolah.</li>
          ...
          <ul>
            ...
            <li><strong>Kepatuhan Hukum:</strong> Jika diwajibkan oleh proses hukum atau untuk melindungi hak legal SchoolPro.</li>
          </ul>

          <h2>5. Penggunaan API Meta (WhatsApp)</h2>
          <p>
            Khusus untuk integrasi WhatsApp menggunakan API Resmi Meta, SchoolPro bertindak sebagai jembatan (Webhook/Gateway) untuk menyampaikan notifikasi. Kami mematuhi Kebijakan Privasi Meta. Pesan yang dikirim menggunakan enkripsi ujung ke ujung (E2EE) ketika telah sampai ke jaringan WhatsApp.
          </p>

          <h2>6. Hak Pengguna</h2>
          <p>
            Sebagai pengelola (Tenant), Anda memiliki hak penuh untuk menambah, mengedit, atau menghapus data sekolah, staf, maupun siswa dari sistem kami melalui Dashboard Admin.
          </p>
