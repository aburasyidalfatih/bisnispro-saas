...
export default async function AffiliateDashboardPage() {
  ...
  const referralLink = `${process.env.NEXT_PUBLIC_APP_URL || "https://bisnispro.id"}/${displayCode}`
  ...
  return (
    <div className="space-y-8">
        ...
        <div className="flex items-center gap-3 bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-500/10 dark:to-amber-500/10 px-4 py-3 rounded-xl border border-orange-200 dark:border-orange-500/20 shadow-sm w-full md:w-fit max-w-xl">
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-orange-700/90 dark:text-orange-400/90 leading-tight">
              Kupon cashback ini sengaja <strong>dibatasi 1 kali penggunaan</strong> khusus untuk <em>upgrade</em> perusahaan Anda sendiri. Besaran cashback <strong>{cashbackValueText}</strong> akan masuk ke saldo komisi Anda. Jika Anda butuh kupon tambahan, silakan <em>request</em> ke Super Admin.
            </p>
          </div>
      ...
      <div className="flex flex-col gap-4">
          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row items-center gap-4 justify-between">
              <div className="space-y-1 text-center md:text-left">
                ...
                <p className="text-sm text-emerald-600 dark:text-emerald-500">Bagikan link ini ke calon perusahaan untuk mendapatkan komisi.</p>
              </div>
            ...
            <CardContent className="p-6 flex flex-col gap-4">
              <div className="space-y-1">
                ...
                <p className="text-sm text-orange-600 dark:text-orange-500">
                  Gunakan kode kupon ini saat checkout langganan. Anda akan menerima saldo komisi senilai nominal cashback, tanpa mengubah total tagihan perusahaan.
                </p>
              </div>
        ...
        <Card className="glass border-blue-500/20 bg-blue-500/5">
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row items-center gap-4 justify-between">
              <div className="space-y-1 text-center md:text-left">
                <h3 className="font-semibold text-blue-800 dark:text-blue-400">Komunitas Mitra BisnisPro</h3>
      ...
      <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-5">
        ...
        <Card className="glass">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Calon Perusahaan</CardTitle>
            <Users className="h-4 w-4 text-muted-foreground" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{referredApplications}</div>
            <p className="text-xs text-muted-foreground mt-1">Perusahaan yang mendaftar</p>
          </CardContent>
        </Card>
        
        <Card className="glass">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Perusahaan Aktif (Free)</CardTitle>
        ...
        <Card className="glass border-emerald-500/20">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Perusahaan Berbayar</CardTitle>
      ...
      <Card className="glass">
        <CardHeader>
          ...
          <CardDescription>Riwayat komisi 5 transaksi terakhir dari perusahaan referensi Anda.</CardDescription>
        </CardHeader>
        <CardContent>
